...
const similarityPoints = [
  "Strong living collections and endangered plant protection",
  "Research hubs linking public exhibits with conservation science",
  "Advanced tools and methods for conservation",
];

const rows = [
  {
    perspective: "Conservation Focus",
    sbg: [
      "Southeast Asian tropical biodiversity",
      "Strength in orchids and rainforest ecosystems",
    ],
    kew: [
  ...
  },
  {
    ...
    sbg: [
      "Orchid hybridisation and tropical conservation",
      "Regional collaborations, including with Kew",
    ],
    kew: [
      "Large multidisciplinary science teams",
      "Genomics, taxonomy, AI identification, global ecology",
    ],
  },
];
...
export const PresenterSlide = ({ photo }) => (
  <SlideShell photo={photo} align="left">
    ...
    <h1 style={styles.heading}>Research, Conservation & Biodiversity</h1>
    <SlideBody />
  </SlideShell>
);
