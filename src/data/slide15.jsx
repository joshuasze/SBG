...
const similarityPoints = [
  ...
  "Both preserve living cultural landscapes and historic structures",
  "Both function as iconic green civic spaces",
];

const rows = [
  {
    topic: "Heritage Identity",
    sbg: [
      "Tropical heritage and Orchid Diplomacy",
      "Strong Southeast Asian ethnobotanical focus",
    ],
    kew: [
      "Victorian heritage and imperial-era architecture",
      "Global botanical collections and archives",
    ],
  },
  {
    topic: "Economic Positioning",
    sbg: [
      "Supports Singapore tourism and City in Nature branding",
      "~4.4M annual visitors",
    ],
    kew: [
      "Revenue from memberships and exhibitions",
      "Strong heritage-tourism model",
    ],
  },
];
...
export const PresenterSlide = ({ photo }) => (
  <SlideShell photo={photo} align="left">
    ...
    <h1 style={styles.heading}>Heritage, Culture & Urban Identity</h1>
    <SlideBody />
  </SlideShell>
);
  ...
  return (
    <div style={styles.layout}>
      ...
      <article style={styles.tableCard}>
        <h2 style={styles.subTitle}>Differences & Insight</h2>
        <div style={styles.tableWrap}>
          <table style={styles.table}>
            ...
            <tbody>
              {rows.map((row) => (
                <tr key={row.topic}>
                  <th scope="row" style={styles.rowHead}>{row.topic}</th>
                  <td style={styles.td}>
